...
namespace RecipeSharingPlatform.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        {
            builder.ApplyConfiguration(new UsersRecepiesEntityTypeConfiguration());
            ...
            if (this.seedDb)
            {
                ...
                builder.Entity<Recipe>().HasData(
                    new Recipe
                    {
                        ...
                        ImageUrl =
                            "https://www.unicornsinthekitchen.com/wp-content/uploads/2024/04/Bruschetta-sq-500x500.jpg",
                    ...
                    new Recipe
                    {
                        ...
                        ImageUrl =
                            "https://feelgoodfoodie.net/wp-content/uploads/2025/04/Grilled-Salmon-09-500x500.jpg",
                        AuthorId = "df1c3a0f-1234-4cde-bb55-d5f15a6aabcd",
                        CreatedOn = DateTime.Now,
                        CategoryId = 2,
                        IsDeleted = false
                    ...
                    new Recipe
                    {
                        ...
                        ImageUrl =
                            "https://www.cookingclassy.com/wp-content/uploads/2022/02/molten-lava-cake-17-500x500.jpg",
                        AuthorId = "df1c3a0f-1234-4cde-bb55-d5f15a6aabcd",
                        CreatedOn = DateTime.Now,
                        CategoryId = 3,
                        IsDeleted = false
